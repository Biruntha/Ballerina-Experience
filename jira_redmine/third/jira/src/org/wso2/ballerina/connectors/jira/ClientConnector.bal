...
connector ClientConnector (string uri, string username, string password) {
    ...
    @doc:Param {value:"jira: The Jira Connector instance"}
    @doc:Return {value:"response object"}
    action getIssueTypes (ClientConnector jira) (GetIssueTypesResponse) {
        message request = {};
        string uriParams;
        string jiraPath = "/rest/api/2/issuetype";

        message responseMessage = basicauth:ClientConnector.get (jiraEP, jiraPath, request);

        json jiraGetIssueTypesJSONResponse = messages:getJsonPayload(responseMessage);
        GetIssueTypesResponse response = getIssueTypesTypeMapper(jiraGetIssueTypesJSONResponse);
    ...
    @doc:Return {value:"response object"}
    action getProject (ClientConnector jira, string projectIdOrKey, string expand) (GetProjectResponse) {
        message request = {};
        string uriParams;
        ...
        json jiraGetProjectJSONResponse = messages:getJsonPayload(responseMessage);
        GetProjectResponse response = getProjectTypeMapper(jiraGetProjectJSONResponse);
...
function getProjectTypeMapper (json jiraGetProjectJSONResponse) (GetProjectResponse) {
    GetProjectResponse response = {getProjectResponse:jiraGetProjectJSONResponse};

    return response;
}

function getIssueTypesTypeMapper (json jiraGetIssueTypesJSONResponse) (GetIssueTypesResponse) {
    GetIssueTypesResponse response = {getIssueTypesResponse:jiraGetIssueTypesJSONResponse};
